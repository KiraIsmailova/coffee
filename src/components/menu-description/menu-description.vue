<template>
  <div class="menu-description">
    <h2 class="main-title main-title--white">Discover the best coffee</h2>
    <p class="menu-description__subtitle main-subtitle main-subtitle--white">
